package com.mooc.meetingfilm.backendcinema.generator;
...
/**
 * Mybatis-plus的逆向代码生成器，可以根据数据库表的结构生成JavaBean和映射文件：
 * 即根据表自动生成dao层
 * 用到了beetl模板引擎
 * @author wang
 * @create 2022-04-18
...
public class EntityGenerator {
    ...
    private String outputDir = "D:\\javastudy\\ProjectFilm\\backend-parent\\backend-cinema\\src\\main\\java";
    // 生成类的作者
    private String author = "wc";
    // 数据源相关配置
    ...
    private String userPwd = "wangchao";
    // DAO的包路径
    private String daoPackage = "com.mooc.meetingfilm.backendcinema.dao";
    // 待生成的表名，注意是覆盖更新
